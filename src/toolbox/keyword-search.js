...
// Keyword code search using Sourcegraph search V3 (patternType standard)
const action = process.env.TOOLBOX_ACTION || ''

if (action === 'describe') {
  process.stdout.write([
    'name: sgcs-keyword-search',
    'description: Keyword code search. Use small number of precise terms. Returns top chunks per file.',
    'query: string The search query. Can include keywords and filters like repo:, file:, etc.'
  ].join('\n'))
  process.exit(0)
